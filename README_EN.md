...
# ⚡ AI Relay Station Deals · 白嫖指南

> 🚀 **Long-term maintained** | Curated list of AI API relay station signup rewards, ranked by credit & quality
> **长期更新中** | 持续收集优质 AI API 中转站注册福利，按额度与质量排序
...
**Please ⭐ Star to support long-term updates!**
**如果觉得有用，请 ⭐ Star 支持长期更新！**
...
An AI relay station aggregates third-party API services into one unified interface, letting you access Claude / GPT models with a lower barrier. Sign up to get free credits — great for trying out, testing, and light usage.

> ⚠️ **Note**: All stations are third-party unofficial services. Policies may change anytime; please refer to each site for details.
...
**Q1: Are these stations safe?**
A: All are third-party unofficial services. Start with small usage to verify stability; avoid large top-ups. This repo only organizes info and bears no financial risk.

**Q2: Do free credits expire?**
A: Policies vary by station. Some have validity periods — use them soon after registering.

**Q3: Can I top up when credits run out?**
A: Most stations support top-up. Verify long-term operation before paying.

**Q4: Why are some models "periodically open"?**
A: Some models (e.g. opus-5) depend on upstream supply; stations open slots periodically. Follow station announcements.
...
**Long-term promise**: This repo stays actively maintained. More stars = more frequent updates 😄

---

## ⚠️ Disclaimer

1. All information comes from public sources, for learning & communication only. Not purchasing advice.
2. All relay stations are **third-party unofficial services**, not affiliated with OpenAI / Anthropic / Youdao.
3. We are not responsible for any financial loss, account risk, or data issues arising from any station. Use at your own discretion.
4. Please comply with each platform's terms and local laws. Use AI services legally and responsibly.

---

<div align="center">

**⭐ Star to support long-term updates | Bookmark & never miss ⭐**
